...
server.use   (corser.create({ endPreflightRequests: false }));
...
/**
 * @param req Request: http request that has a session property
 */
// server.setToastMessage = function(req, level, message){
// 	if(req.session && level && message){
// 		req.session.toastMessage = {
// 			level: level,
// 			message: message
